...
if not st.session_state["api_key"]:
    ...
    if submit_button:
        ...
        st.write("คำแนะนำ")
        st.write("ข้อกำหนดทางกฎหมายและข้อบังคับ:")
        st.write(f"- โรงงานแปรรูปผลไม้จำเป็นต้องปฏิบัติตามพระราชบัญญัติโรงงาน พ.ศ. 2535 และกฎกระทรวงที่เกี่ยวข้องกับการผลิตอาหาร เช่น มาตรฐาน GMP และ HACCP")

        st.write("ใบอนุญาตและเอกสารที่จำเป็น:")
        st.write(f"- ใบอนุญาต รง.4 สำหรับโรงงานอุตสาหกรรม")
        st.write(f"- หนังสืออนุญาตจากสำนักงานคณะกรรมการอาหารและยา")
        st.write(f"- เอกสารประกอบ เช่น แผนผังโรงงาน, รายการเครื่องจักร, และแผนการผลิต")

        st.write("ขั้นตอนการดำเนินการ:")
        st.write(f"- จัดทำแผนผังโรงงานและแผนการผลิตเพื่อยื่นขอใบอนุญาต รง.4 ต่อกรมโรงงานอุตสาหกรรม")
        st.write(f"- ขอรับการตรวจสอบมาตรฐาน GMP/HACCP จากหน่วยงานที่เกี่ยวข้อง")
